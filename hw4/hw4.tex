...
\begin{enumerate}
  ...
  \item
    ...
    \begin{solution}
      ...
      The basic idea is that we cannot get convergence in probability or almost surely because the distributions of $\frac{S_n}{\sqrt{n}}$ are
      approaching $Z$, but for values of $n_1$ and $n_2$ very different from each other, $\frac{S_{n_1}}{\sqrt{n_1}}$ and
      $\frac{S_{n_2}}{\sqrt{n_2}}$ may look very different and may be close to independent.
